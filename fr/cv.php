...
?>
  ...
  <div style="margin-left: 15%">
	...
	<li><p><strong>Duke University</strong>: B.A., Philosophy, 2011</p></li>
      ...
      <h3 id="primary-instructor">Primary instructor</h3>
      <p>All courses given at NC State.</p>
      <table>
	<thead>
	  <tr class="header">
	    <th>Term</th>
	...
	<tbody>
	  <tr class="odd">
	    <td>2021 Summer 2</td>
	    <td>Topics in Contemporary Mathematics</td>
	  </tr>
	  <tr class="even">
	    <td>2019 Fall</td>
	    <td>Calculus III - Multivariable calculus</td>
	  </tr>
	  <tr class="odd">
	    <td>2019 Summer 2</td>
	    <td>Topics in Contemporary Mathematics</td>
      ...
      <p>All courses given at NC State.</p>
      <p>Secondary instructional role (recitation leader):</p>
      <table>
	<thead>
	  <tr class="header">
	    <th>Term</th>
	...
	<tbody>
	  ...
	  <tr class="odd">
	    <td>2020 Spring</td>
	    <td>Calculus I - Single-variable calculus</td>
	  </tr>
	  <tr class="even">
	    <td>2019 Spring</td>
	    <td>Calculus III - Multivariable calculus</td>
      ...
      <p>Lecture assistant (grading and office hours):</p>
      <table>
	<thead>
	  <tr class="header">
	    <th>Term</th>
